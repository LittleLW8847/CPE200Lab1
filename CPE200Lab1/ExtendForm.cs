...
namespace CPE200Lab1
{
    public partial class ExtendForm : Form
    {
        ...
        private void btnUnaryOperatir_click(object sender , EventArgs e)
        {
        ...
        private void btnMR_Click(object sender, EventArgs e)
        {
            ...
            lblDisplay.Text = temp_memory.ToString();
        }
        ...
        private void btnMPlus_Click(object sender, EventArgs e)
        {
            ...
            temp_memory += Convert.ToDouble(lblDisplay.Text);
        }

        private void btnMSubstract_Click(object sender, EventArgs e)
        {
            if(lblDisplay.Text == "Error")
            {
                return;
